//William:
//Een verdere uitbreiding op de eerste "sample.c", speelt geluid af op een external speaker.
...
#define SPEAKER_VOLUME 20 // Adjust volume as needed
...
void setup() {
  ...
  dfplayer.volume(SPEAKER_VOLUME); // Set volume
